...
class Input(Nodes, AbstractInput):
    ...
    def __init__(
        ...
        refrac: Union[int, torch.Tensor] = 60,
        ...
        **kwargs,
        ...
        self.refrac_count = torch.zeros((1,n), device=self.refrac_count.device)   
    ...
    def forward(self, x: torch.Tensor) -> None:
        ...
        #print(x.size())
        #print(self.refrac_count.size())
        x[self.refrac_count > 0] = 0
        self.s = x.byte()
       ...
       # if self.lbound is not None:
        ...
        self.refrac_count[(self.refrac_count == 0) & (self.s!=0)] = self.refrac.float()
